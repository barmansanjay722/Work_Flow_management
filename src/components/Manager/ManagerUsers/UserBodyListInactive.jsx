...
import { getInActiveUser } from "../../../services/managerService";
import { Link } from "react-router-dom";
import CustomPagination from "../ManagerWorkLists/CustomPagination";

const UserBodyListInactive = ({ setInActiveUserCount, setFilterPagination, filterList, filterPagination ,setPendingCount }) => {
  ...
  useEffect(() => {
    ...
    fetchActiveUser(filterList = {...filterList , inactive : true});
  ...
  async function fetchActiveUser() {
    ...
    response = await getInActiveUser(dataPerPage, currentPage, filterList);
    setActiveUser(response?.data);
    setInActiveUserCount(response?.data?.totalRecords);
                ...
                <td className="d-flex align-items-center">
                  <div className="symbol symbol-circle symbol-50px overflow-hidden me-3">
                    <div className="symbol-label">
                      {/* <img src="../assets/media/avatars/300-4.jpg" alt="Kiran Patil" className="w-100" /> */}
...
export default UserBodyListInactive;